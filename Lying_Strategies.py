...
# return true colors of the neighbors
def lying_strategy_sample():
...
# if you have new lying strategies, implement them similar to lying_strategy_sample to return colors of the neighbors
